...
function PresentationPatternsExample() {
  return (
    <div className="space-y-8 p-6">
      <PageHeader
        breadcrumbs={[
          { label: 'Exemplos', href: '/app/exemplos' },
          { label: 'Apresentação' },
        ]}
        eyebrow="Biblioteca compartilhada"
        title="Padrões de apresentação"
        description="Composições isoladas que podem ser copiadas sem importar lógica de domínio."
        actions={
      ...
      <Card>
        ...
        <CardContent>
          <DataTableSkeleton label="Carregando tabela de exemplo" rowCount={3} />
        </CardContent>
      </Card>
    </div>
  )
...
export { PresentationPatternsExample }
