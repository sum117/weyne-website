  ...
  return (
    <SheetPortal>
      ...
      <SheetPrimitive.Content
        ...
        className={cn(
          'fixed z-overlay flex flex-col gap-4 bg-white shadow-[0_40px_70px_-34px_rgb(1_20_36/0.5)] transition ease-house data-[state=closed]:animate-out data-[state=closed]:duration-300 data-[state=open]:animate-in data-[state=open]:duration-500',
          side === 'right' &&
